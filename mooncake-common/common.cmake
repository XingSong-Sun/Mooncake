...
option(USE_CUDA_HETEROGENEOUS "option for transferring between NVIDIA GPU and RDMA without GPUDirect" OFF)
...
if (USE_CUDA_HETEROGENEOUS)
  ...
  add_compile_definitions(USE_CUDA_HETEROGENEOUS)
  message(STATUS "CUDA Heterogeneous RDMA transport is enabled")
endif()
